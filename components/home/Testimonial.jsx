  ...
  return (
    <section className="py-16 ">
      <div className="max-w-screen-xl mx-auto text-center">
        <h1>Testimonial</h1>
        <div className="testimonial-box max-w-4xl mx-auto my-12 grid grid-cols-2 gap-5 justify-center place-items-center	">
          {testimonials.map((elem, ind) => (
            <div className="testimonial-item p-8 border-2 border-black rounded-xl text-center " key={ind}>
              ...
              <span className="text-xl">{elem.text}</span>
              <h5 className="mt-6">{elem.author}</h5>
            </div>
          ))}
        </div>
      </div>
